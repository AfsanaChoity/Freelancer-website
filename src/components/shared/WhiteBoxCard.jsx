    ...
    return (
        <motion.div
            ...
            >
                ...
                <h2 className={`${item.title === "Pending Request" ? "text-[#FFBA51]" : "text-[#6F6F6F]"}`}>{item.title}</h2>
                <p className={`${item.title === "Pending Request" ? "text-[#FFBA51] text-3xl" : "text-[#8BCF9A] text-3xl"}`}>{item.count} </p>
