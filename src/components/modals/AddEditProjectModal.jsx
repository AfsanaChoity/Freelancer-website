...
export default function AddEditProjectModal ({ open, onClose, onPublish, create = false, edit = false, heading }) {
            ...
            >
                <div className='grid md:grid-cols-3 gap-2 '>
                    <div className='mt-7 flex justify-center md:justify-start'>
                        ...
                        <Form.Item name="image" valuePropName="fileList" getValueFromEvent={normFile}>
                            ...
                            <Upload action="/api/upload" name="file" listType="picture-card">
                                ...
                                >
                                    <PictureOutlined />
                                    <div style={{ marginTop: 8 }}>Upload Image/Video</div>
                                </button>
                            </Upload>
                        </Form.Item>
                    ...
                    <div className='md:col-span-2'>
                        <Form.Item label="Project Title" name="name">
