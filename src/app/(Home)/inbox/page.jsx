...
import { Search, Video, Paperclip, Send, Download, Play } from "lucide-react";
...
const MessagingInterface = () => {
  ...
  return (
    <CustomContainer>
        <div className="flex h-screen bg-white rounded-md font-poppins">
      {/* Left Sidebar - Inbox */}
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            />
            <div>
              <div className="bg-gray-200 rounded-2xl rounded-tl-none px-4 py-3 max-w-md">
          ...
          <div className="flex items-start gap-3 justify-end">
            <div>
              <div className="bg-green-100 rounded-2xl rounded-tr-none px-4 py-3 max-w-md">
                <p className="text-sm text-gray-800">Hlw Jhon, How Can I Help You??</p>
              </div>
          ...
          <div className="flex justify-end">
            <div className="flex items-center gap-4  border border-gray-200 rounded-xl p-4 max-w-lg shadow-sm">
          ...
          <div className="flex items-center justify-center py-2">
            <div className=" border border-gray-200 rounded-full px-4 py-1 text-xs text-gray-600 shadow-sm">2 unread messages</div>
          </div>
      ...
      <div className="w-80 border-l border-gray-200 flex flex-col">
        <div className="p-6 text-center border-b border-gray-200">
          ...
          <button className="w-full border border-blue-600 text-blue-600 font-medium py-2 rounded-lg hover:bg-blue-50">View Profile</button>
        </div>
